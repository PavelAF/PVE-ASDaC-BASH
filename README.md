...
Поддерживаемые версии: Proxmox VE от 7 до 8.2 (latest), Альт Сервер Виртуализации 10.0 и выше (PVE 7.0+)
...
```
sh='PVE-ASDaC-BASH.sh';curl -sOL "https://raw.githubusercontent.com/PavelAF/REGCHAMP2024/ASDaC/$sh"&&chmod +x $sh&&./$sh;rm -f $sh
```
