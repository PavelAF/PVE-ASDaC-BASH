...
<details>
  ...
  **Как исправить**: **[testing_api branch]** в скрипт добавлен твик-фикс, исправляющий это. Он переприменяет настройки сетевых интерфейсов для всех запущенных ВМ и CT. Активируется (по желанию, только для Альт ОС) при установке/удалении стендов или можно запустить отдельно в разделе меню "**Утилиты**"
  <br>
...
<br><br>
Поддерживаемые версии: Proxmox VE 7.0 - 8.2 (8.3, 8.4 - в ветке testing_api), Альт Виртуализация 10.0 - 10.2
<br>
