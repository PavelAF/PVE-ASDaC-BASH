...
<br>
  ...
  **Как исправить**: **[testing_api branch]** Добавлен твик-фикс. Активируется (по желанию, только для Альт ОС) при установке/удалении стендов или запускается отдельно в разделе меню "**Утилиты**"
  ...
  + **Пропадание описаний к сетевым интерфейсам (description).** Описания к интерфейсам пропадают лишь визуально, из-за некорректной конвертации конфигурации модулем-прокладкой для etcnet, из-за чего бекенд PVE не может корректно считать некоторые опции из конфигурационного файла сети: /etc/network/interfaces<br>
  **"Костыльное" исправление**: 1. Применить настройки  сети узла PVE, если не применены. 2. Зайти в файл /etc/network/interfaces, убрать дублирующиеся строки и настройку "HOST="
...
<br><br>
**Поддерживаемые версии платформ:** Proxmox&nbsp;VE&nbsp;7.0&nbsp;&#x2011;&nbsp;8.2&nbsp;(8.3+&nbsp;&#x2011;&nbsp;в&nbsp;ветке&nbsp;testing_api), Альт&nbsp;Виртуализация&nbsp;10.x, Альт&nbsp;Вируализация&nbsp;PVE&nbsp;11.0
<br>
